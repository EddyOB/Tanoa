...
class WeaponShops {
    ...
    class genstore {
        ...
        items[] = {
			...
			{ "axe", "", 800, 400, "" },
			{ "pickaxe", "", 800, 400, "" },
			{ "tf_anprc152_1","Radio 5km", 500, 200, "" },
            { "TheProgrammer_Repair_System_door", "", 1700, 500, "" },
			{ "TheProgrammer_Repair_System_engine", "", 4000, 2000, "" },
			{ "TheProgrammer_Repair_System_fuel", "", 450, 200, "" },
			{ "TheProgrammer_Repair_System_lights", "", 250, 100, "" },
			{ "TheProgrammer_Repair_System_wheel", "", 350, 150, "" },
			{ "TheProgrammer_Repair_System_windows", "", 2000, 1000, "" }
